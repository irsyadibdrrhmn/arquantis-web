...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#050d1a] flex flex-col">
      ...
      {/* Glow orbs */}
      <div
        className="absolute top-1/3 right-1/4 h-[400px] w-[400px] rounded-full bg-[#00e5ff] opacity-[0.04] blur-[100px] animate-pulse-glow"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-1/4 left-1/2 h-[300px] w-[300px] rounded-full bg-[#ff2d78] opacity-[0.03] blur-[80px] animate-pulse-glow"
        style={{ animationDelay: "2s" }}
      />
      {/* Gold orb */}
      <div
        className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 h-[200px] w-[200px] rounded-full bg-[#c9a45c] opacity-[0.06] blur-[90px] animate-pulse-glow"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                ...
                <br />
                <span className="text-gradient-gold">{t("hero", "h1b")}</span>
                <br />
              </h1>
                ...
                <button className="relative group rounded-xl border border-[rgba(255,255,255,0.12)] bg-[rgba(255,255,255,0.04)] px-7 py-3.5 font-display text-xs font-bold tracking-[0.15em] uppercase text-white transition-all hover:border-[rgba(0,229,255,0.35)] hover:bg-[rgba(0,229,255,0.05)] hover:text-[#00e5ff]">
                  <span className="flex items-center gap-2">
                    <span className="h-3 w-3 rounded-full border-2 border-current flex items-center justify-center">
                      <span
                        className="block h-1.5 w-1 ml-0.5"
                        style={{
                          borderWidth: "3px",
                          borderStyle: "solid",
                          borderColor:
              ...
              >
                {[
                  { val: "12+", labelKey: "stat1", color: "#00e5ff" },
                  { val: "24/7", labelKey: "stat2", color: "#c9a45c" },
                  { val: "99.97%", labelKey: "stat3", color: "#ff2d78" },
                  { val: "Global", labelKey: "stat4", color: "#00e5ff" },
                ].map((s, i) => (
                  <div
                    key={i}
                    className="glass-card-cyan rounded-xl p-4 card-hover"
                  >
                    <div
                    ...
                    <div className="mt-1 font-mono text-[10px] tracking-[0.2em] uppercase text-[#7a8fa6]">
                      {t("hero", s.labelKey)}
                    </div>
                  </div>
                ))}
            ...
            >
              <div className="relative rounded-2xl border border-[rgba(0,229,255,0.2)] bg-[rgba(8,21,38,0.8)] backdrop-blur-xl p-6 shadow-[0_0_60px_rgba(0,229,255,0.08)]">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <div className="font-mono text-[10px] tracking-[0.2em] uppercase text-[#7a8fa6]">
                      {t("hero", "chartLabel")}
                    </div>
                    <div className="font-display text-2xl font-bold text-gradient-cyan mt-1">
                      +38.7%
                    </div>
                  </div>
                ...
                <div className="flex items-end gap-1.5 h-36 mb-4">
                  {[
                    40, 55, 35, 70, 50, 80, 60, 90, 65, 100, 75, 88, 70, 95, 85,
                  ].map((h, i) => (
                    <div
                      key={i}
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="font-mono text-xs text-[#7a8fa6]">
                          {s.name}
                        </span>
                      </div>
                      <span
              ...
              <div className="absolute -top-4 -right-4 rounded-xl border border-[rgba(201,164,92,0.4)] bg-[rgba(5,13,26,0.9)] px-4 py-3 backdrop-blur animate-float shadow-[0_0_20px_rgba(201,164,92,0.2)]">
                <div className="font-mono text-[9px] tracking-[0.2em] text-[#7a8fa6] uppercase">
                  Sharpe Ratio
                </div>
                <div className="font-display text-xl font-bold neon-gold">
                  1.87
                </div>
              </div>
              <div
                className="absolute -bottom-4 -left-4 rounded-xl border border-[rgba(255,45,120,0.3)] bg-[rgba(5,13,26,0.9)] px-4 py-3 backdrop-blur animate-float shadow-[0_0_20px_rgba(255,45,120,0.15)]"
                style={{ animationDelay: "1s" }}
              >
                <div className="font-mono text-[9px] tracking-[0.2em] text-[#7a8fa6] uppercase">
                  Win Rate
          ...
          <div className="ticker-inner animate-ticker">
            {doubled.map((item, i) => (
              <span key={i} className="inline-flex items-center gap-2 px-6">
                <span className="font-mono text-[10px] tracking-[0.2em] uppercase text-[#7a8fa6]">
                  {item.label}
                </span>
                <span
                  className={`font-mono text-[10px] font-bold ${item.positive ? "text-[#00e5ff]" : "text-[#ff2d78]"}`}
                  style={{
