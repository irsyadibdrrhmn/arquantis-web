  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: `linear-gradient(90deg, transparent, ${accentColor}, ${accentColor2}, transparent)` }}
      />

      {/* glow orbs */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 h-[500px] w-[700px] rounded-full blur-[130px] pointer-events-none"
        style={{ background: accentColor, opacity: 0.05 }}
      />
      <div
        className="absolute bottom-0 left-1/4 h-[300px] w-[400px] rounded-full blur-[100px] pointer-events-none"
        style={{ background: accentColor2, opacity: 0.03 }}
      />

      {/* corner brackets */}
      <div className="absolute top-24 left-8 w-14 h-14 border-l-2 border-t-2 rounded-tl-lg" style={{ borderColor: `${accentColor}40` }} />
      <div className="absolute top-24 right-8 w-14 h-14 border-r-2 border-t-2 rounded-tr-lg" style={{ borderColor: `${accentColor2}40` }} />
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <h1 className="font-display text-5xl font-black leading-[1.05] text-white md:text-6xl xl:text-7xl">
          {title}
        </h1>

        {subtitle && (
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8" style={{ color: "#7a8fa6" }}>
            {subtitle}
          </p>
        )}
